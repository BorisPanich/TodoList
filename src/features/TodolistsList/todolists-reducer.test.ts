...
test('correct todolist should be removed', () => {
    const endState = todolistsReducer(startState, removeTodolistTC.fulfilled({id: todolistId1}, "requestId", "todolist1"))
...
test('correct todolist should change its name', () => {
    ...
    let newVar = {id: todolistId2, title: newTodolistTitle};
    const action = changeTodolistTitleTC.fulfilled(newVar, "requestId", newVar)
